...
export default function Maintenance() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <PageHeader
        title="Maintenance"
        subtitle="Audit logs and login activity for users enrolled in your institution"
        actions={
          <>
            <Button
              variant="outline"
      ...
      <Tabs
        ...
        layoutId="owner-maintenance-tabs"
        items={[
          ...
          {auditLoading ? (
            ...
            <Card padding="p-0">
              <EmptyState
                ...
                message="Create, update, and delete actions by your institution's users will show up here."
              />
            </Card>
          ) : (
          ...
          {loginsLoading ? (
            ...
            <Card padding="p-0">
              <EmptyState
                ...
                message="Sign-ins and sign-outs from your institution's users will show up here."
              />
            </Card>
          ) : (
            <Card padding="p-0" className="overflow-hidden">
